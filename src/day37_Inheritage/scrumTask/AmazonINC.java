package day37_Inheritage.scrumTask;

import day31_Constructors.Movie;
...
public class AmazonINC {
    ...
    public static void main(String[] args) {
        ...
        Tester tester1=new Tester("Chinara",32,'F',"QA",224,125000,company);

        Tester tester2=new Tester("Yasaman",31,'F',"QE",45646,130000,company);

        Tester tester3=new Tester("Irena",29,'F',"SDET",4488,128000,company);

        Tester tester4=new Tester("Cihad",26,'M',"QA",6464,125000,company);
